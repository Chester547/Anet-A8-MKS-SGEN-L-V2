...
#define STRING_CONFIG_H_AUTHOR "(ChMaker, 2020 config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 216.62
  #define DEFAULT_bedKi 34.99
  #define DEFAULT_bedKd 894.05
...
#define Z_SERVO_ANGLES { 5, 85 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -59.458, 2.688, -5.3 }
...
#define XY_PROBE_FEEDRATE (150*50)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (20*50)
...
#define HOMING_FEEDRATE_MM_M { (100*50), (100*50), (4*50) }
...
//
//f#define MAKEBOARD_MINI_2_LINE_DISPLAY_1602
...
//
// SH1106 OLED full graphics generic display
//
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN            CASE_LED_PIN     // LED driving pin
  #define NEOPIXEL2_TYPE          NEO_GRB
  #define NEOPIXEL2_PIN           SERVO1_PIN
